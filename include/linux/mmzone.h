...
struct zone_reclaim_stat {
	 ...
	 */
	//从active的lru到inactive lru的page的个数
...
//pageset中的page是已经分配了的，不管用户最终有没有从pageset中申请，在统计上已经不算是free
//的了
...
//做了一些优化以节省空间，使多个page共享一个wait_queue，利弊注释都很清楚。
...
#ifdef CONFIG_COMPACTION
//表示此次被唤醒要分配的order(也就是我们应该回收的order)
	int kcompactd_max_order;
//此次回收最大的zone
	enum zone_type kcompactd_classzone_idx;
//kcompactd线程无事可做时在此处睡眠
...
#endif
//mem_section数组指针，每个item表示有SECTIONS_PER_ROOT个mem_section
